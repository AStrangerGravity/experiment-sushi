requirejs(["charts/basic_vote", "charts/candidate_breakdown", "charts/irv_vote", "showdown", "candidate_info" ],
  (basic_vote, candidate_breakdown, irv_vote, showdown, candidate_info) => {
